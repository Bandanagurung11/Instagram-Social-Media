...
export default function LeftFixed({ NotExpand }: { NotExpand: boolean }) {
  ...
  const items = [
    ...
    {
      icon: <SquarePlus className="h-7 w-7" />,
      name: "Create",
    },
    {
  ...
  return (
    <div
      className={`fixed h-screen hidden lg:block top-0 left-0 ${
        NotExpand ? "w-16" : "w-60"
      } border-r border-r-gray-200 px-2`}
    >
